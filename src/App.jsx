...
function ContactForm() {
  return (
    <form name="contact" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" className="space-y-4 text-left">
      ...
      <button type="submit" className="group inline-flex w-full items-center justify-center rounded-full bg-lime-300 px-8 py-5 text-sm font-black uppercase tracking-[0.14em] text-black transition hover:bg-white sm:w-auto">
        Send Message <ArrowIcon className="ml-2 transition group-hover:translate-x-1 group-hover:-translate-y-1" />
      </button>
    </form>
  );
}
