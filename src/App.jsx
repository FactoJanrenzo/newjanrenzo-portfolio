    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="group block">
          <span className="mb-2 block text-xs font-black uppercase tracking-[0.24em] text-white/40">
            Name
          </span>
          <input
            name="name"
            ...
            className="w-full rounded-3xl border border-white/10 bg-white/[0.04] px-5 py-4 text-white outline-none transition placeholder:text-white/25 focus:border-lime-300/60 focus:bg-white/[0.07]"
          />
        </label>
      ...
      <label className="group block">
        ...
        <input
          name="subject"
          required
          placeholder="Website redesign, landing page, GHL setup..."
          className="w-full rounded-3xl border border-white/10 bg-white/[0.04] px-5 py-4 text-white outline-none transition placeholder:text-white/25 focus:border-lime-300/60 focus:bg-white/[0.07]"
        />
      </label>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="group block">
          ...
          <select
            name="projectType"
            className="w-full rounded-3xl border border-white/10 bg-[#121212] px-5 py-4 text-white outline-none transition focus:border-lime-300/60 focus:bg-[#171717]"
          >
      ...
      <label className="group block">
        ...
        <textarea
          ...
          required
          rows="6"
          placeholder="Tell me about your website, funnel, timeline, goals, and what you want to improve."
          className="w-full resize-none rounded-[2rem] border border-white/10 bg-white/[0.04] px-5 py-4 text-white outline-none transition placeholder:text-white/25 focus:border-lime-300/60 focus:bg-white/[0.07]"
        />
      </label>
      ...
      <button
        ...
        className="group inline-flex w-full items-center justify-center rounded-full bg-lime-300 px-8 py-5 text-sm font-black uppercase tracking-[0.14em] text-black transition hover:bg-white disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
      >
        {formStatus === "sending" ? "Sending..." : "Send Message"}
        <ArrowIcon className="ml-2 transition group-hover:translate-x-1 group-hover:-translate-y-1" />
      </button>
    </form>
  );
}
