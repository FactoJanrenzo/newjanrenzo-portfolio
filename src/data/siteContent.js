...
export const services = [
  { iconType: "design", title: "WordPress Design & Development", text: "Custom Elementor, Divi, Kadence, Beaver Builder, Avada, and Enfold builds designed for real business results." },
  { iconType: "funnel", title: "GoHighLevel Funnels & Automations", text: "Landing pages, workflows, pipelines, calendars, forms, triggers, SMS, and email automation setup." },
  { iconType: "speed", title: "SEO + Conversion Structure", text: "Content structure, page hierarchy, local-service messaging, trust blocks, and CTA placement for better leads." },
  { iconType: "code", title: "Frontend Customization", text: "HTML, CSS, JavaScript, ACF, responsive fixes, custom sections, integrations, and lightweight enhancements." },
];

export const toolsTop = ["WordPress", "Elementor", "Divi", "GoHighLevel", "HTML", "CSS", "JavaScript", "ACF", "SEO", "PageSpeed", "Canva", "Adobe Suite"];
export const toolsBottom = ["Kadence", "Beaver Builder", "Avada", "Enfold", "GHL Funnels", "GHL CRM", "GHL Workflows", "Landing Pages", "Core Web Vitals", "API Support", "Responsive Design", "Front-End Customization"];

export const processSteps = [
  "Audit your current site or offer",
  "Plan sitemap, sections, and conversion flow",
  "Design premium responsive layouts",
  "Build in WordPress, GHL, or custom frontend",
  "Optimize speed, SEO, and launch details",
];

export const filters = ["All", "WordPress", "GHL", "SEO", "Frontend", "Design", "Performance"];

export const creativeOrbitItems = [
  { label: "Developer", symbol: "</>" },
  { label: "WordPress", symbol: "WP" },
  { label: "GHL", symbol: "GHL" },
  { label: "Design", symbol: "*" },
  { label: "SEO", symbol: "SEO" },
  { label: "Video", symbol: "VID" },
];
...
export const experienceReviews = [
  { score: "01", title: "Clear Strategy Before Design", text: "Every build starts with offer clarity, sitemap planning, page flow, and conversion goals before jumping into visual layout." },
  { score: "02", title: "Premium Look With Practical Execution", text: "The design direction stays modern and high-end, but the backend remains easy to manage through WordPress, Elementor, or GHL." },
  { score: "03", title: "Built For Leads, Speed, And Trust", text: "Sections are structured around trust signals, direct CTAs, fast-loading layouts, mobile responsiveness, and SEO-friendly content hierarchy." },
];

const portfolioBase = "https://raw.githubusercontent.com/FactoJanrenzo/PortfolioSimpleModern/main/PorfolioSite%20Janrenzo/assets/portfolio";

export const portfolioGraphics = [
  { title: "Business Website Promo", category: "Web Design", image: `${portfolioBase}/website-business.jpg` },
  { title: "Vortex VA Hiring Creative", category: "Recruitment Graphic", image: `${portfolioBase}/vortex-hiring-va.jpg` },
  { title: "Vortex Quote Design", category: "Brand Social", image: `${portfolioBase}/vortex-quote.jpg` },
  { title: "Mushroom Benefits Campaign", category: "Health Creative", image: `${portfolioBase}/mushroom-benefits.jpg` },
  { title: "Power Outage Solar Creative", category: "Solar Marketing", image: `${portfolioBase}/power-outage.jpg` },
  { title: "Mother's Day Service Post", category: "Event Creative", image: `${portfolioBase}/mothers-day.jpg` },
  { title: "Empowerment Night", category: "Church Event", image: `${portfolioBase}/empowerment-night.jpg` },
  { title: "Leaders Convergence", category: "Event Branding", image: `${portfolioBase}/leaders-convergence.jpg` },
  { title: "Power Night", category: "Social Media", image: `${portfolioBase}/power-night.jpg` },
];
...
export const whyWorkWithMe = [
  "I can own the full website process from planning to launch.",
  "I understand both design and technical implementation.",
  "I build with conversion, speed, and SEO structure in mind.",
  "I can support WordPress, GoHighLevel, frontend, and creative assets.",
];

export const responseFlow = [
  "You send your project details",
  "I review the scope and goals",
  "We align on timeline and deliverables",
  "I build, optimize, and launch",
];
